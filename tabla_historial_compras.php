...
// Obtener todos los registros de historial de compras de la base de datos
$sqlHistorialCompras = "SELECT * FROM historial_compras";
$resultHistorialCompras = $con->query($sqlHistorialCompras);
?>
...
<div class="hero_area">
    ...
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <?php
        // Mostrar la tabla de historial de compras
        echo '<table class="table">';
        echo '<thead>';
        echo '<tr>';
        echo '<th style="text-align: center;">ID Compra</th>';
        ...
        // Mostrar los registros de historial de compras en la tabla
        while ($row = $resultHistorialCompras->fetch_assoc()) {
            echo '<tr>';
            echo '<td style="text-align: center;">' . $row["ID_compra"] . '</td>';
