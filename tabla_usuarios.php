...
<div class="hero_area">
    ...
    <div class="container">
      <div class="heading_container heading_center">
        ...
        echo '<th style="text-align: center;">Número de Tarjeta</th>';
        echo '<th style="text-align: center;">Código Postal</th>';
        ...
        while ($row = $resultUsuarios->fetch_assoc()) {
            echo '<tr>';
            echo '<td style="text-align: center;">' . $row["ID_usuario"] . '</td>';
            echo '<td style="text-align: center;">' . $row["nombre_usuario"] . '</td>';
            echo '<td style="text-align: center;">' . $row["email"] . '</td>';
            echo '<td style="text-align: center;">' . $row["fecha_nacimiento"] . '</td>';
            echo '<td style="text-align: center;">' . $row["numero_tarjeta"] . '</td>';
            echo '<td style="text-align: center;">' . $row["codigo_postal"] . '</td>';
            // Agregar columnas adicionales según sea necesario
            echo '</tr>';
        }
